...
export const SegmentView: React.FC<PropsWithChildren<Props>> = (props: PropsWithChildren<Props>) => {
    ...
    return ( 
         ...
         <Style.DivContainer>
            ...
            <Style.Div>
                <TbPlaneArrival/>
                <Style.CountryH1>{props.cityInfo.city_destination.country}</Style.CountryH1>
                <Style.CityP>{props.cityInfo.city_destination.city}</Style.CityP>
                <Style.CityP>{props.cityInfo.city_destination.code_airport}</Style.CityP>
            </Style.Div>
